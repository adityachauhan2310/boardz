    ...
    <>
      <Message>
        <Trans i18nKey="common.plankaUsesAppriseToSendNotificationsToOver100PopularServices">
          {'Add your webhook URLs or tokens to receive notifications. For Slack, use format: '}
          <a href="https://github.com/caronc/apprise/wiki/Notify_slack" target="_blank" rel="noreferrer">
            <b>slack://TOKEN_A/TOKEN_B/TOKEN_C</b>
          </a>
          {' or other services like Discord, Telegram, etc.'}
        </Trans>
      </Message>
      {ids.map((id) => (
